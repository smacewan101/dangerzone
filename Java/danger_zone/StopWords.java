...
*@since 2012-10-17
*
* Class to just hold the Stop Words that we'll remove from the tweet
*/
public class StopWords{
	static final String [] strippers = {  "a", "about", "above", "across", "after", "afterwards", 
